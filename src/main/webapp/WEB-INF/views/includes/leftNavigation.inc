<ul id="slide-out" class="side-nav">
	<li>
		<div class="userView">
			<img class="background"
				src="<c:url value="/resources/images/kegs9T.jpg" />" /> <a
				href="#!user"><img class="circle"
				src="<c:url value="/resources/images/userimage.jpg" />" /> </a> <a
				href="#!name"><span class="white-text name">John Doe</span></a> <a
				href="#!email"><span class="white-text email">jdandturk@gmail.com</span></a>
		</div>
	</li>
	<li><a href="#! "
		onclick="ajaxGeturlForSideNav('editProfile','mainContainer');"><i
	...
	<li><a href="#!"
		onclick="ajaxGeturlForSideNav('shareRecipe','mainContainer');"><i
			class="material-icons">email</i>Share New Recipe</a></li>
	<li>
		<div class="divider"></div>
	</li>
	<li><a href="#!"
	...
	<li><a href="#!"
		onclick="ajaxGeturlForSideNav('recipeDetailsFav','mainContainer');"><i
			class="material-icons">note_add</i>Favorites</a></li>
	<li>
		<div class="divider"></div>
	</li>
